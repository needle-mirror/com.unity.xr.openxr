...
namespace UnityEngine.XR.OpenXR.CompositionLayers
{
    ...
    public static class OpenXRLayerUtility
    {
        ...
        /// <summary>
        /// A transformation helper built from a Unity position and rotation.
        /// </summary>
        public struct TransformPose
        {
            ...
            /// </summary>
            public static TransformPose operator*(TransformPose lhs, TransformPose rhs)
            {
                var ret = new TransformPose();
            ...
            /// </summary>
            public TransformPose Inverse()
            {
                TransformPose ret;
                ret.rotation = Quaternion.Inverse(rotation);
        ...
        /// </summary>
        public static TransformPose ToTransformPose(this Transform t, bool isLocal = false)
        {
            TransformPose pose;
            pose.rotation = t.rotation;
        ...
        /// </summary>
        public static TransformPose ComputePoseTrackingSpace(Transform layerTransform)
        {
            if (_mainCameraCache == null)
                _mainCameraCache = Camera.main;

            TransformPose headPose;
            headPose.position = _mainCameraCache.transform.localPosition;
            headPose.rotation = _mainCameraCache.transform.localRotation;

            TransformPose headSpacePose = _mainCameraCache.transform.ToTransformPose().Inverse() * layerTransform.ToTransformPose();
            var ret = headPose * headSpacePose;
