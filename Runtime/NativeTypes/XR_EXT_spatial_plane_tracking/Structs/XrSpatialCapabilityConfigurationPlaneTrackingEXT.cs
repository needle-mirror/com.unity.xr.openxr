...
namespace UnityEngine.XR.OpenXR.NativeTypes
{
    ...
    public readonly unsafe struct XrSpatialCapabilityConfigurationPlaneTrackingEXT : ISpatialCapabilityConfiguration
    {
        ...
        /// <see cref="XrStructureType.SpatialCapabilityConfigurationPlaneTrackingEXT"/>.
        /// </summary>
        ...
        /// <summary>
        /// The capability being configured: <see cref="XrSpatialCapabilityEXT.PlaneTracking"/>.
        /// </summary>
            ...
            void* next, uint enabledComponentCount, XrSpatialComponentTypeEXT* enabledComponents)
        {
            ...
            type = XrStructureType.SpatialCapabilityConfigurationPlaneTrackingEXT;
            this.next = next;
            capability = XrSpatialCapabilityEXT.PlaneTracking;
